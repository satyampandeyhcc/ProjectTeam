...
const Home = () => {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      ...
      setLoading(false);
      if (loaderRef.current) loaderRef.current.stopLoading();
    };
          ...
          >
            <Navbar.Brand href="/">
              <p className="headname">
                Explore Varanasi live! Secure your ride today!
              </p>
            </Navbar.Brand>
            <Navbar.Toggle />
            <Navbar.Collapse className="justify-content-end ">
              <Navbar.Text className="removenav">
                <img className="my-logo-nav" alt="" src={email} />
                &nbsp;
                <a
                  style={{ textTransform: "none" }}
                  href="mailto:bikeridingventure@gmail.com"
                >
              ...
              <Navbar.Text className="removenav">
                <img className="my-logo-nav" alt="" src={phone} />
                ...
                <div className="col-lg-6 col-md-6 col-sm-12">
                  <div className="mt-5 py-lg-5 w-75 m-5">
                    <p className=" my-para-section5  mt-lg-2">
                      Welcome to BikeRiding Venture – Your Trusted Riding
                      Partner!
                      <br /> <br />
                      Discover the joy of biking in the serene plains with Plain
                      Ventures! Specializing in top-notch bike adventures in
                      flat landscapes, we bring the thrill of mountain biking to
                      the plains. Our carefully crafted tours are designed by
                      experienced riders who understand the needs of fellow
                      biking enthusiasts. At Plain Ventures, we prioritize your
                      satisfaction and fun, ensuring every detail of your biking
                      experience is organized with style, passion, and
                      expertise. Embrace the beauty of the plains as we take you
                      on exciting rides, offering not just biking but a chance
                      to immerse yourself in local culture, history, and
                      traditions.
                    </p>
                  </div>
                </div>

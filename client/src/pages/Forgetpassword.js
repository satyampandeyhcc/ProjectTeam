...
function ForgetPassword() {
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      const response = await fetch(
        "https://bikeridingventure.onrender.com/api/users/passChange",
        {
          method: "PUT",
          headers: {
  ...
  async function handleSubmit(values) {
    ...
    try {
      const response = await fetch(
        "https://bikeridingventure.onrender.com/api/users/sendEmail",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://bikeridingventure.onrender.com/api/users/verifyOTP",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
